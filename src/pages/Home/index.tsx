...
const Home = () => {
    return (
        ...
        <Header />
            ...
            <p>Não sabe quantas horas por dia precisa se dedicar para determinado contaúdo para cumprir seus objetivos?</p>
        ...
        <Button variant="contained" color="primary">Experimente</Button> 
        </div>
        </div>
    );
    }
